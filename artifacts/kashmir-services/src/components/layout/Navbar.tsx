...
import { User, Menu, X, Home, Users, UserPlus, LayoutDashboard, ShieldCheck, HelpCircle, LogOut } from "lucide-react";
          ...
          <SheetContent side="right" className="w-72 p-0 flex flex-col">
            ...
            {isLoggedIn && (
              <div className="px-5 py-3 border-b bg-muted/30">
                ...
                <p className="text-sm font-semibold truncate">{appUser?.name ?? firebaseUser.email}</p>
                <p className="text-xs text-primary capitalize">{appUser?.role ?? ""}</p>
              </div>
            )}
